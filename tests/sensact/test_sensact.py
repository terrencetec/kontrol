...
def test_optical_lever_sensing_matrix():
    ...
    kontrol_ol2eul.delta_x = delta_x
...
def test_vertical_optical_lever_sensing_matrix():
    # Old SRM optical lever sensing matrix from my old scripts
    correct_matrix = np.array([
        [-0.08378354, 0.01293162, -3.27137886, 0.07679314],
        [2.2622183, 0.01609096, 1.33690529, -0.03138284],
    ...
    delta_y = 0.037
    delta_x = -0.0044
    kontrol_ol2eul = kontrol.VerticalOpticalLeverSensingMatrix(
        r=r, alpha_h=alpha_h, alpha_v=alpha_v,
        r_lens=r_lens, f=f, phi_tilt=phi_tilt, phi_len=phi_len,
        delta_y=delta_y, delta_x=delta_x
    )
    # Test setters and decorators
    kontrol_ol2eul.r = r
    kontrol_ol2eul.r_lens = r_lens
    kontrol_ol2eul.delta_d = 0
